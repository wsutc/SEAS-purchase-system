...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL("ALTER TABLE `seas_purchasing`.`setup_sheets_setupsheet` DROP FOREIGN KEY setup_sheets_setupsheet_part_id_78796717_fk_setup_sheets_part_id;"),
        migrations.RunSQL("ALTER TABLE `seas_purchasing`.`setup_sheets_setupsheet` DROP COLUMN `part_id`;"),
