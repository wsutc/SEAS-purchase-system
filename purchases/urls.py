...
from purchases.views.views_functions import dynamic_tracker_data
...
urlpatterns = [
    ...
    path(
        "vendor/orders/new/",
        VendorOrderCreateView.as_view(),
        name="vendororder_create",
    ),
    path(
    ...
    path(
        "purchase-request/<slug:slug>/pdf",
        generate_pr_pdf,
        name="generate_pdf",
    ),
    path(
    ...
    path(
        f"webhooks/tracking/{settings.TRACKER_WEBHOOK_URL}/", tracking_webhook
    ),
    path("trackers/", TrackerListView.as_view(), name="tracker_list"),
    path(
        "trackers-dynamic/", dynamic_tracker_data, name="dynamic-tracker-list"
    ),
    ...
    path(
        "trackers/<slug:pk>/update-tracker/",
        update_tracker,
        name="update_tracker",
    ),
    path(
        "trackers/<slug:pk>/delete/",
    ...
    path(
        "account-balances/", BalancesListView.as_view(), name="balances_list"
    ),
    path(
