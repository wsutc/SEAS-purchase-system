...
urlpatterns = [
    ...
    path("purchase-request/generate-csv/", generate_csv_prs, name="generate_csv"),
    path("purchase-request/generate-vendor-csv/", generate_csv_vendors, name="generate_csv_vendors"),
    path("purchase-request/generate-items-csv/", generate_csv_items, name="generate_csv_items"),
    ...
    path(f"webhooks/tracking/{settings.TRACKER_WEBHOOK_URL}/", tracking_webhook, name="tracking_webhook"),
